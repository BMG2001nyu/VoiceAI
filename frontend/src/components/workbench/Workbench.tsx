            ...
            <div className="p-6 border-b border-border bg-gradient-to-br from-primary/[0.03] to-transparent">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h2 className="text-sm font-bold text-foreground">Synthesis Engine is analyzing AI portfolio gaps...</h2>
                    </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-card/60 border border-border/50 shadow-sm relative overflow-hidden group">
                    ...
                    <p className="text-[13px] text-muted-foreground leading-relaxed relative z-10 pr-12">
                        The system is currently aggregating financial data from 4 agents to determine the liquidity of Sequoia's recent AI bets.
                        <span className="text-foreground font-medium"> Finding: 34% of recent capital is locked in foundational models.</span>
                    </p>
            ...
            <div className="flex-1 p-6 flex flex-col gap-6">
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <button className="text-[10px] font-bold text-primary hover:underline uppercase">View Full Logs</button>
                    </div>
                            ...
                            <div key={agent.id} className="flex gap-4 group">
                                ...
                                <div className="flex-1 space-y-1.5 pb-4">
                                    ...
                                    <div className="p-3 rounded-lg bg-secondary/30 border border-border/40 text-[11px] font-mono text-muted-foreground leading-relaxed">
                                        {agent.steps[agent.steps.length - 1]?.message || "Initializing connection..."}
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between p-3 rounded-xl border border-border bg-card/20 hover:bg-card/40 transition-colors cursor-pointer group">

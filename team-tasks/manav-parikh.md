...
|------|-------|-------------|------------|
| 2.1 | Infrastructure | AWS core network and compute (VPC, ECS Fargate, ALB) | Phase 1 |
| 2.2 | Infrastructure | Redis / ElastiCache cluster | 2.1 |
| 2.3 | Infrastructure | Postgres RDS or DynamoDB | 2.1 |
| 2.4 | Infrastructure | S3 buckets | 2.1 |
| 2.5 | Infrastructure | Vector store (OpenSearch Serverless) | 2.1 |
| 4.1 | Orchestrator | Mission state machine and storage | 2.3 |
| 4.2 | Orchestrator | Mission CRUD API | 4.1 |
| 4.3 | Orchestrator | Context packet builder | 4.1 |
| 4.4 | Orchestrator | Task graph construction (Nova Lite) | 4.1, 4.3 |
| 4.5 | Orchestrator | Orchestrator planning loop | 4.3, 4.4 |
| 9.1 | Streaming | Redis pub/sub channel definitions | 2.2, 4.1, 6.1 |
| 13.2 | Observability | Metrics emission (CloudWatch / OTel) | Phase 3–6, 9 |
| 13.3 | Observability | CloudWatch dashboards and alarms | 13.2 |
| 13.4 | Observability | Distributed tracing (AWS X-Ray) | 13.1 |
